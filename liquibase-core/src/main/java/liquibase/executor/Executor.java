...
public interface Executor {
    ...
    /** Write methods */
    void execute(ExecutableChange change) throws DatabaseException;

    void execute(ExecutableChange change, List<SqlVisitor> sqlVisitors) throws DatabaseException;
