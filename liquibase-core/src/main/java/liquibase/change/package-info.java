 ...
 * <p></p>
 * Liquibase ships with a set of changes that range from low level create table style changes to higher level "introduce lookup table" style changes,
 * but additional custom changes can be added via by creating new {@link liquibase.change.ExecutableChange} implementations and including them in the classpath.
 *
