...
public class ChangeLogParametersImpl implements ChangeLogParameters {
    ...
    public ChangeLogParametersImpl() {
        this(null);
    }

    public ChangeLogParametersImpl(Database database) {
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#setContexts(liquibase.Contexts)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#getContexts()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#set(java.lang.String, java.lang.Object)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#set(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#set(java.lang.String, java.lang.String, liquibase.ContextExpression, liquibase.Labels, java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#getValue(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#hasValue(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#expandExpressions(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#setLabels(liquibase.LabelExpression)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see liquibase.changelog.IChangeLogParameters#getLabels()
     */
    @Override
    ...
    private class ChangeLogParameter {
        ...
        public boolean isValid() {
            boolean isValid = validContexts == null || validContexts.matches(ChangeLogParametersImpl.this.currentContexts);
