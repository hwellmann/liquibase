...
public class MarkChangeSetRanExecuteTest extends AbstractExecuteTest {
    ...
    public void generateSql_insert() throws Exception {
        this.statementUnderTest = new MarkChangeSetRanStatement(new ChangeSetImpl("a", "b", false, false, "c", "e", "f", null), ChangeSet.ExecType.EXECUTED);
    ...
    public void generateSql_update() throws Exception {
        this.statementUnderTest = new MarkChangeSetRanStatement(new ChangeSetImpl("a", "b", false, false, "c", "e", "f", null), ChangeSet.ExecType.RERAN);
